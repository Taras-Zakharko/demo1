...
const CandidateContacts: FC<ICandidateContacts> = ({
  contactsRef,
  setEditUser,
  user,
  labelW,
  ...
  const [messenger, setMessenger] = useState<{[key: string]: string | number}[]>([{name:0,path:''}])
        ...
        <div className='accordion-body ps-8 pt-0 pb-7 pb-lg-0'>
          <div className='row d-flex mb-7 mb-lg-20px'>
            <div
              className={
                'col-lg-' +
                labelW +
                ' d-flex justify-content-between align-items-center align-items-lg-start'
              }
            >
              <label
                ...
                ? phoneNumber.map((number, i) => {
                    if (i === 0) {
                      ...
                      return (
                        <div
                          key={i}
                          className='row mt-7 mt-lg-20px position-relative'
                          id={'phone-' + i}
                        >
                          <div className='col-11'>
                            <input
                              ...
                              value={number}
                              onChange={(e) =>
                                cangeArray(e, i, phoneNumber, setPhoneNumber, 'phone')
                              }
                            />
                          </div>
                          <div className='col-1 d-flex flex-center mb-4'>
                            <button
                              ...
                              onClick={() => removeArray(i, setPhoneNumber, 'phone')}
                            >
          ...
          <div className='row d-flex mb-7 mb-lg-20px'>
            ...
            >
              <label
                htmlFor='exampleFormControlInput1'
                className='form-label pt-lg-3 required fw-normal mb-5 mb-lg-2 fs-5 fs-sm-6'
              >
                Ел. пошта
              </label>
              <button
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className='col-1 d-flex flex-center mb-4'>
                            <button
                              className='btn p-0 cursor-pointer'
                              onClick={() => removeArray(i, setEmail, 'email')}
                            >
                              <i className='fas fa-trash text-gray-500 fs-16px fs-sm-4'></i>
                            </button>
                          </div>
          ...
          <div className='row d-flex mb-7 mb-lg-20px'>
            ...
            >
              ...
              <button
                className='btn p-0 text-primary border-bottom border-dashed border-primary rounded-0 d-block d-lg-none mb-5 mb-lg-2 fs-6 fs-sm-7'
                onClick={() => setMessenger((mess) => mess.concat({name: 0, path: ''}))}
              >
                Додати ще
              </button>
            </div>
                ...
                ? messenger.map((mess, i) => {
                    if (i === 0) {
                      ...
                      return (
                        <div
                          key={i}
                          className='row mt-7 mt-lg-20px align-items-center'
                          id={'messenger-' + i}
                        >
          ...
          <div className='row d-flex '>
            ...
            >
              ...
              <button
                className='btn p-0 text-primary border-bottom border-dashed border-primary rounded-0 d-block d-lg-none mb-5 mb-lg-2 fs-6 fs-sm-7 '
                onClick={() => setUserLinks((link) => link.concat({name: 0, path: ''}))}
              >
                Додати ще
              </button>
            </div>
