...
const candidatesApi = {
  ...
  getCandidate: (city: string, specialty: string, skills: string[], page: number) =>
    axiosInstance.get(`/candidates?city=${city}&specialty=${specialty}&skills=${skills}&page=${page}&perPage=30`),
